...
CREATE TABLE `appointment` (
  ...
  `MenteeId` int unsigned NOT NULL,
  `MentorId` int unsigned NOT NULL,
  `MatchDate` date NOT NULL,
  `IsMatchMentor` tinyint(1) DEFAULT NULL,
  `IsMatchMetee` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
INSERT INTO `appointment` VALUES (1,1,2,'2021-01-03',0,0),(3,2,3,'2021-01-03',0,0);
